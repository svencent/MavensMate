...
Metadata.prototype.isLightningType = function() {
  return this.getType().xmlName === 'AuraDefinitionBundle';
};

Metadata.prototype.getLightningDefinitionType = function() {
  if (this.getExtension() === 'css') {
    return 'STYLE';
  } else if (this.getExtension() === 'app') {
    return 'APPLICATION';
  } else if (this.getExtension() === 'auradoc') {
    return 'DOCUMENTATION';
  } else if (this.getExtension() === 'cmp') {
    return 'COMPONENT';
  } else if (this.getExtension() === 'evt') {
    return 'EVENT';
  } else if (this.getExtension() === 'intf') {
    return 'INTERFACE';
  } else if (this.getExtension() === 'js') {
...
Metadata.prototype.isToolingType = function() {
  ...
  return supportedExtensions.indexOf(this.getExtension()) >= 0 || this.getType().xmlName === 'AuraDefinitionBundle';
};
...
MetadataService.prototype.getTypeByPath = function(p) {
  ...
  if (path.basename(grandparentPath) === 'aura') {
