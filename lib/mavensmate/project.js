  ...
  Q.when(fileProperties, function (properties) {
    try {
      ...
      _.each(properties, function(fp) {
        logger.debug(fp);
        var metadataType = self.getMetadataTypeByPath(fp.fileName);
 ...
 * @return {Promise}
 */
Project.prototype._indexChildren = function(indexedType, typeMap, xmlName, childNames) {
  var deferred = Q.defer();
  var self = this;
 ...
 * @return {Promise}
 */
Project.prototype._indexFolders = function(indexedType, typeMap, xmlName) {
  var deferred = Q.defer();
  var self = this;
 ...
 * @return {Promise}
 */
Project.prototype._indexType = function(typeListResult, typeMap) {
  var deferred = Q.defer();
 ...
 * @return {Promise}
 */
Project.prototype.indexServerProperties = function() {
  var deferred = Q.defer();
  var self = this;
  ...
  var listRequests = [];
  _.each(self.getSubscription(), function(type) {
    typeMap[type] = self.getMetadataTypeByName(type);
 ...
 * @return {String}
 */
Project.prototype._transformFolderNameForListRequest = function(typeName) {
...
Project.prototype._transformFolderNameToBaseName = function(typeName) {
...
Project.prototype.getMetadataTypeByPath = function(p) {
  logger.debug('getMetadataTypeByPath');
  logger.debug(p);
  var ext = p.split('.').pop();
  return this.getMetadataTypeBySuffix(ext); 
};
 ...
 * @return {Object}
 */
Project.prototype.getMetadataTypeByName = function(name) {
  var type;
  var self = this;
 ...
 * @return {Object}
 */
Project.prototype.getMetadataTypeBySuffix = function(suffix) {
  var type;
  var self = this;
  if (suffix.indexOf('.') >= 0) {
    suffix = suffix.replace(/\./g, '');
  }
  logger.debug('getMetadataTypeBySuffix');
 ...
 * @return {Object}
 */
Project.prototype.getMetadataTypeByDirectoryName = function(dirName) {
  var type;
  var self = this;
  _.each(self.describe.metadataObjects, function(metadataType) {
