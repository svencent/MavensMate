...
Project.prototype.compileMetadata = function(metadata) {
  ...
  self.sfdcClient[compilerMethod](metadata, self)
    .then(function(result) {
      deferred.resolve(result);
    })
    ['catch'](function(error) {
...
Project.prototype.refreshFromServer = function(metadata) {
  ...
  self.sfdcClient.retrieveUnpackaged(metadataPayload)
    ...
    .then(function() {
      return self._updateLocalStore(fileProperties);
    })
    .then(function() {
...
Project.prototype._updateLocalStore = function(fileProperties) {
  var deferred = Q.defer();
  var self = this;
