      ...
      _.each(res, function(r) {
        if (_.has(r, 'State')) {
          ...
          if (r.State === 'Completed') {
            ...
            result.details.componentErrors.push(r);
...
CompileDelegate.prototype._performCompile = function() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var toolingFiles = mavensMateFile.getToolingFiles(files);
    ...
    if (lightningBundleItemFiles.length > 0) {
      compilePromises.push(self._compileLightningBundleItemPaths(lightningBundleItemFiles));
    }
