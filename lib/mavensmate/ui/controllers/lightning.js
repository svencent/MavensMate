...
LightningController.prototype.createApp = function(req, res) {
  ...
  this.client.executeCommandForProject(req.project, 'new-lightning-app', req.body, req.editor)
...
LightningController.prototype.createComponent = function(req, res) {
  ...
  this.client.executeCommandForProject(req.project, 'new-lightning-component', req.body, req.editor)
    .then(function(response) {
      jobQueue.finish(jobId, null, response);  
    })
    .catch(function(err) {
...
LightningController.prototype.createEvent = function(req, res) {
  ...
  this.client.executeCommandForProject(req.project, 'new-lightning-event', req.body, req.editor)
    .then(function(response) {
      jobQueue.finish(jobId, null, response);  
    })
    .catch(function(err) {
...
LightningController.prototype.createInterface = function(req, res) {
  ...
  this.client.executeCommandForProject(req.project, 'new-lightning-interface', req.body, req.editor)
    .then(function(response) {
      jobQueue.finish(jobId, null, response);  
    })
    .catch(function(err) {
