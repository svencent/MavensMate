module.exports = {
  ...
  mm_template_location: {
    ...
    description: 'Possible values: remote or local',
    type: 'string',
    default: 'remote',
    order: 130
  },
  mm_template_source: {
    ...
    description: 'URL of MavensMate templates. For remote template locations, only GitHub repositories are supported today.',
    type: 'string',
