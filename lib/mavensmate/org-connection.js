 ...
 */
OrgConnectionService.prototype.add = function(username, password, orgType, loginUrl) {
  var self = this;
  return new Promise(function(resolve, reject) {
    ...
    var orgConnectionClient = new SalesforceClient({ username: username, password: password, orgType: orgType, loginUrl: loginUrl });
 ...
 * @return {Promise}
 */
OrgConnectionService.prototype.update = function(id, username, password, orgType, loginUrl) {
  var self = this;
  return new Promise(function(resolve, reject) {
    if (!fs.existsSync(path.join(self.project.path, 'config', '.org_connections'))) {
