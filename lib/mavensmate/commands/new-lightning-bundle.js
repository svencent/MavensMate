...
Command.prototype.execute = function() {
  ...
  if (self.isUICommand() && self.client.editor === 'sublime') {
    ...
    editorService.launchUI('new-lightning-bundle');   
  } else {
    var project = self.getProject();
    var lightningService = new LightningService(project.sfdcClient);
    return lightningService.createBundle(self.payload.apiName, self.payload.description)
