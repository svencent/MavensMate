...
var RefreshService    = require('../refresh');
...
Command.prototype.execute = function() {
  ...
  if (self.isUICommand() && self.client.editor === 'sublime') {
    ...
    return lightningService.createBundle(apiName, self.payload.description)
      ...
      .then(function() {
        newAuraMetadata.writeToDisk();
        var refreshService = new RefreshService(project);
        return refreshService.refreshFromServer([newAuraMetadata]);
      })
      .then(function() {
