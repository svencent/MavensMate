...
// populates project appropriately based on whether it's a new project
//  > if new project, set project id
//  > if existing project, populate settings, debug, session, local_store, etc.
...
// retrieves requested metadata, writes to disk, populates config/ directory
...
// compiles project based on package.xml
...
// TODO: accept package, update project accordingly
