...
Project.prototype.edit = function(pkg) {
  ...
  global.logger.debug('requested package is: ', pkg);
  global.sfdcClient.retrieveUnpackaged(pkg)
    .then(function(retrieveResult) {
      var retrieveResultStream = retrieveResult.zipStream;
...
Project.prototype.indexMetadata = function() {
  ...
  var self = this;
  // todo: stash existing
  Metadata.indexServerProperties(self.getSubscription())
    .then(function(res) {
...
Project.prototype._writeSession = function() {
  ...
  var session = {
    accessToken: global.sfdcClient.getAccessToken(),
    instanceUrl: global.sfdcClient.conn.instanceUrl
  };
