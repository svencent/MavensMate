...
describe('mavensmate refresh-metadata-cli', function(){
  ...
  it('should accept a metadata path', function(done) {
    if (os.platform() === 'win32') {
      program._events['refresh-metadata'](['C:\\path\\to\\something']);
      ...
      program._events['refresh-metadata'](['/path/to/something']);
  ...
  it('should accept stdin', function(done) {
    program._events['refresh-metadata']();
